    ...
    public function voteForIdea($idea_id, $vote_value, $user_id) {
      ...
      if ($infinite ['data']==0){
        ...
        if ($delegated_user==0){
          ...
          // this does not work because if doegating user votes multiple times (changes his mind) the delegated user is constantly decremented/incremented
          // this can only happen once so basically the delegation to this user must be revoked as soon as the delegating user votes
