...
[ -f ./legacy/config/base_config.php ] && \
  echo "  [*] You already have ./config/base_config.php. Delete it to regenerate it." || \
  cp -n ./legacy/config/base_config.php-example ./legacy/config/base_config.php
[ -f ./legacy/config/instances_config.php ] && \
  echo "  [*] You already have ./config/instances_config.php. Delete it to regenerate it." || \
  cp -n ./legacy/config/instances_config.php-example ./legacy/config/instances_config.php
