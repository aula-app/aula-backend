...
#RUN  apt install -yqq --force-yes php7.4-bcmath 
#RUN  apt install -yqq --force-yes php7.4-curl 
#RUN  apt install -yqq --force-yes  php7.4-dom php7.4-mbstring php7.4-intl
