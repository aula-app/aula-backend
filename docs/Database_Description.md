...
HOlds data for the password information of a user
...
Defines user groups, contains all base data for the user group, also contains future use fields like access_code, vote_bias etc.
